...
/**
 * Retrieve user profile from ComicsGL.
 *
 * This function constructs a normalized profile, with the following properties:
 *
 *   - `provider`         always set to `comicsgl`
 *   - `id`               the user's ComicsGL ID
 *   - `username`         the user's ComicsGL username
 *   - `displayName`      the user's full name
 *   - `profileUrl`       the URL of the profile for the user on ComicsGL
